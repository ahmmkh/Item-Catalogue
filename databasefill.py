...
soccerShort = CategoryItem(user_id=1, name='Umbro Youth Knit Soccer Shorts', description='Gear your '
                           ...
                           + 'waistband is complete with an internal drawcord for a secure, adjustable fit.', price='$9.97', picture='soccer-shorts.png', category=Soccer)
...
soccerShoes = CategoryItem(user_id=1, name="adidas Men's Nemeziz Messi 17+ 360 Agility FG Soccer Cleats",
                           ...
                           + 'power, speed and push off support on natural grass pitches.', price='$289.99', picture='soccer-shoes.png', category=Soccer)
